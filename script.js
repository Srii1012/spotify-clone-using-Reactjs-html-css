...
const Header = () => {
  ...
  return(
    ...
    React.createElement("i", { class: "fa fa-user-circle fa-lg", "aria-hidden": "true" }), "Srii",
    ...
    React.createElement("li", null,React.createElement("a", { href: "#", target: "_blank" }, "",React.createElement("i", { class: "fa fa-external-link", "aria-hidden": "true" }))),
...
const Body = () => {
  ...
  return(
    ...
    React.createElement("div", { class: "category" },
    React.createElement("div", { class: "title" },
    React.createElement("h3", null, "Made For Srii"),
    React.createElement("a", { href: "#" }, "SEE ALL")),
